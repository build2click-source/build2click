        ...
        <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] border border-[#F0F0F0] shadow-[0_10px_30px_rgba(0,0,0,0.03)] flex flex-col md:flex-row items-center justify-between py-6 md:py-8 px-6 md:px-10 relative">
          {STATS.map((stat, i) => (
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 pointer-events-none z-30 transition-all duration-[600ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:opacity-100 group-hover:scale-[1.4] group-hover:-translate-y-[80%]">
              ...
              {/* Stat Content */}
              <div className="relative z-10 transform transition-transform duration-500 ease-out group-hover:scale-[0.98] group-hover:translate-y-1 bg-transparent text-center px-4 w-full">
                <div className="text-[2.5rem] md:text-[3.5rem] lg:text-[4rem] font-bold text-charcoal mb-2 leading-none tracking-tight transition-opacity duration-500 group-hover:opacity-10">
