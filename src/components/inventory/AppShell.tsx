        ...
        <div style={{ display: 'flex', minHeight: '100vh', position: 'relative' }}>
            ...
            >
                ...
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
                    ...
                    <Link href="/inventory-app/products" style={{
                        display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem',
                        borderRadius: '0.5rem', textDecoration: 'none',
                        color: pathname.startsWith('/inventory-app/products') ? 'var(--foreground)' : '#64748b',
                        background: pathname.startsWith('/inventory-app/products') ? 'var(--input)' : 'transparent',
                        fontWeight: 500,
                    }}>
                        <Package size={18} />
                        Products
                    ...
                    <Link href="/inventory-app/invoices" style={{
                        display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem',
                        borderRadius: '0.5rem', textDecoration: 'none',
                        color: pathname.startsWith('/inventory-app/invoices') ? 'var(--foreground)' : '#64748b',
                        background: pathname.startsWith('/inventory-app/invoices') ? 'var(--input)' : 'transparent',
                        fontWeight: 500,
                    }}>
                        <FileText size={18} />
                        Invoices
                    </Link>
                    <Link href="/inventory-app/analytics" style={{
                        display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem',
                        borderRadius: '0.5rem', textDecoration: 'none',
                        color: pathname.startsWith('/inventory-app/analytics') ? 'var(--foreground)' : '#64748b',
                        background: pathname.startsWith('/inventory-app/analytics') ? 'var(--input)' : 'transparent',
                        fontWeight: 500,
                    }}>
                        <BarChart3 size={18} />
                        Analytics
                ...
                <div style={{ borderTop: '1px solid var(--border)', paddingTop: '1.25rem', marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                    <Link href="/inventory-app/settings" style={{
                        display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.625rem 1rem',
                        borderRadius: '0.5rem', textDecoration: 'none',
                        color: pathname === '/inventory-app/settings' ? 'var(--foreground)' : '#64748b',
                        background: pathname === '/inventory-app/settings' ? 'var(--input)' : 'transparent',
                        fontWeight: 500, fontSize: '0.9rem',
                    }}>
                        <Settings size={17} />
                        Settings
                    </Link>
                    <Link href="/inventory-app/settings/stores" style={{
                        display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.5rem 1rem 0.5rem 2.25rem',
                        borderRadius: '0.5rem', textDecoration: 'none',
                        color: pathname === '/inventory-app/settings/stores' ? 'var(--foreground)' : '#64748b',
                        background: pathname === '/inventory-app/settings/stores' ? 'var(--input)' : 'transparent',
                        fontWeight: 500, fontSize: '0.82rem',
                    }}>
                        <Store size={15} />
                        Stores & Warehouses
                    </Link>
                    <Link href="/inventory-app/settings/users" style={{
                        display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.5rem 1rem 0.5rem 2.25rem',
                        borderRadius: '0.5rem', textDecoration: 'none',
                        color: pathname === '/inventory-app/settings/users' ? 'var(--foreground)' : '#64748b',
                        background: pathname === '/inventory-app/settings/users' ? 'var(--input)' : 'transparent',
                        fontWeight: 500, fontSize: '0.82rem',
                    }}>
                        <Users size={15} />
                        User Management
                    </Link>
                    <Link href="/inventory-app/settings/roles" style={{
                        display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.5rem 1rem 0.5rem 2.25rem',
                        borderRadius: '0.5rem', textDecoration: 'none',
                        color: pathname === '/inventory-app/settings/roles' ? 'var(--foreground)' : '#64748b',
                        background: pathname === '/inventory-app/settings/roles' ? 'var(--input)' : 'transparent',
                        fontWeight: 500, fontSize: '0.82rem',
                    }}>
                        <Shield size={15} />
                        Role Permissions
