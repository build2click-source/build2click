...
const features = [
  {
    ...
    desc: "Emoji-anchored scales and a friendly design keep you motivated.",
  },
  {
    emoji: "✨",
    title: "Deep Insights",
...
export default function CareerDNAHome() {
    ...
    ? (isAdmin
        ...
        : (targetAsmt 
            ? (targetAsmt.status === "COMPLETED" 
                ? (targetAsmt.attemptId ? `/careerdna/results/${targetAsmt.attemptId}` : "/careerdna/dashboard")
                : `/careerdna/dashboard/${targetAsmt.id}`) 
            : "/careerdna/dashboard"))
    : "/careerdna/register";
