...
export default function CareerDNARegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/careerdna/auth/register", {
        method: "POST",
    ...
    <div className="min-h-screen bg-[#f8f6f5] flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/careerdna" className="inline-flex items-center gap-2 group">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-10">
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link href="/careerdna/login" className="text-[#fb6a51] font-semibold hover:underline">
              Sign in
            </Link>
          </p>
        </div>
