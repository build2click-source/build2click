  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
        <Link href="/inventory-app/products" className="card glass-panel" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', textDecoration: 'none' }}>
          <div>
        ...
        <Link href="/inventory-app/invoices" className="card glass-panel" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', textDecoration: 'none' }}>
          <div>
        ...
        <Link href="/inventory-app/analytics" className="card glass-panel" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.75rem', textDecoration: 'none' }}>
        ...
        <Link href="/inventory-app/products?filter=low_stock" className="card glass-panel" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', textDecoration: 'none' }}>
          <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 350px), 1fr))', gap: '1.5rem' }}>
        ...
        <div className="card" style={{ padding: 0 }}>
          <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Link href="/inventory-app/invoices" style={{ fontSize: '0.875rem', color: 'var(--primary)' }}>View All →</Link>
          </div>
            ...
            {recentInvoices.length === 0 ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                {recentInvoices.map(inv => {
                  ...
                  return (
                    <Link key={inv.id} href={`/inventory-app/invoices/${inv.id}`} className="glass-panel" style={{
