            ...
            <div className="max-w-7xl mx-auto px-5 lg:px-8 grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div className="flex space-x-4">
                        {[Instagram, Linkedin, Twitter, WhatsApp].map((Icon, i) => (
                            <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#C8A153] hover:text-white hover:border-[#C8A153] transition-all duration-300">
                                <Icon size={16} />
                            </a>
                        ))}
                    </div>
